...
As candidaturas ao Programa Doutoral em Engenharia e Políticas Públicas são submetidas online, através das plataformas indicadas pelo Técnico e pela Área de Pós-Graduação. As candidaturas são aceites em permanência, mas apenas são avaliadas nos períodos definidos para apreciação.

O programa funciona em dois formatos: o **grau dual IST/CMU**, em parceria com a Carnegie Mellon University (programa CMU-Portugal), e o **percurso integralmente no IST**. A via de candidatura difere consoante o formato pretendido.
...
O programa destina-se preferencialmente a detentores de formação em **engenharia**, sendo a experiência profissional relevante valorizada. Podem ser aceites candidatos de outras áreas, desde que demonstrem uma base sólida em ciência e tecnologia. Os candidatos considerados devem possuir **excelentes conhecimentos de métodos quantitativos**.
...
A candidatura deve ser instruída de acordo com as indicações da Área de Pós-Graduação. Apenas são avaliadas candidaturas completas, validadas administrativamente e com os respectivos emolumentos liquidados.
