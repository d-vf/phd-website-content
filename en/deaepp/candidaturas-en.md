...
Applications for the Doctoral Programme in Engineering and Public Policy are submitted online through the platforms indicated by Técnico and the Postgraduate Area. Applications are accepted continuously but are only evaluated during the defined review periods.
 
The programme operates in two formats: the **IST/CMU dual degree**, in partnership with Carnegie Mellon University (CMU-Portugal Program), and the **track entirely at IST**. The application process differs depending on the desired format.
...
The evaluation and ranking of the application consider:
 
- the candidate's CV, training, and professional experience
- the quality of the institution where the master's degree was obtained
...
The evaluation process generally takes place in two phases:
 
1. evaluation of the candidate's previous education, including scientific affinity, academic path, and the degree-awarding institution
...
- acceptance letter from the supervisor or co-supervisors, if supervision is already defined
...
To submit your application, access the platform, and confirm the exact dates of the review periods for the current academic year, please consult the following official links:
 
* **Notice of Deadlines and Access to the Connect Platform:** [Doctoral Programmes (3rd cycle) – Applications](https://posgraduacao.tecnico.ulisboa.pt/arquivos/programas-doutorais-3o-ciclo-candidaturas-11/)
...
- [Doctoral Scholarships — Postgraduate Area](https://posgraduacao.tecnico.ulisboa.pt/en/programas-doutorais/bolsas-de-doutoramento/)
