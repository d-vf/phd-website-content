...
The Doctoral Programme in Engineering and Public Policy (DEAEPP) consists of a doctoral curricular component and the preparation of an original research thesis.
 
The overall structure corresponds to **240 ECTS**, with a standard duration of **4 years / 8 semesters**, organised as follows:
 
| Component | Credits |
|---|---:|
| Doctoral Course (curricular component) | 30 ECTS |
| Doctoral Thesis in Engineering and Public Policy | 210 ECTS |
| **Total** | **240 ECTS** |
 
The predominant scientific area of the cycle of studies is **Engineering and Management**.
...
## Curricular Structure by Scientific Area
 
| Scientific Area | Acronym | Compulsory | Optional |
|---|---|---:|---:|
| Organisation Engineering and Management | EGO | 12 ECTS | — |
| Systems Engineering and Management | EGS | 6 ECTS | — |
| Engineering and Management Scientific Areas (Thesis) | ACEG | 210 ECTS | — |
| Options — All scientific areas of IST | OL | — | 12 ECTS |
...
1. **Curricular component**, corresponding to the Doctoral Course, with **30 ECTS**
2. **Research component**, corresponding to the curricular unit **Doctoral Thesis in Engineering and Public Policy**, with **210 ECTS**
The curricular component allows the student to consolidate advanced training at the interface between engineering, technology, and public policy, select curricular units aligned with their own research direction, and complete transferable-skills training relevant to the development of the doctorate.
...
The programme operates in two formats:
 
1. [**IST/CMU Dual Degree**](https://cmuportugal.org/dual-degree-phd/) — in partnership with Carnegie Mellon University, where students spend part of their studies at CMU in order to obtain the dual degree;
...
According to the study plan published in Order No. 6462/2021, the 30 ECTS are distributed across three scientific areas:
...
|---|---|---|---:|
| Public Policies Theory, Practice and Analysis | EGO | 1st year, 1st semester | 6 ECTS |
| Free Option | OL | 1st year, 1st semester | 6 ECTS |
| Models and Applications in Decision Analysis | EGS | 1st year, 2nd semester | 6 ECTS |
| Quantitative Research Methods | EGO | 1st year, 2nd semester | 6 ECTS |
| Free Option | OL | 1st year, 1st or 2nd semester | 6 ECTS |
| Thesis | ACEG | 1st year (annual) | 30 ECTS |
| Thesis | ACEG | 2nd year (annual) | 60 ECTS |
...
Free options can be chosen from **all scientific areas of IST**, allowing the student to build up training aligned with their own research direction and thesis topic. The list of optional curricular units is set each year by the IST bodies competent under the law and the Institute's statutes.
...
These initiatives are available to students of the Doctoral Programme in Engineering and Public Policy, complementing advanced training and the development of the thesis.
...
- **Deadline:** The proposed composition of the CAT must be submitted to the coordinator of the doctoral programme **within 12 months of the date of official enrolment** (Article 14, paragraph 2).
- **Composition:**
  - The committee may have a **maximum of six members** (additional members are permitted only exceptionally and with proper justification).
  - It comprises the supervisory team plus at least two professors, researchers, or experts of recognised standing who are eligible to sit on the jury, provided that the supervisory members do not outnumber the remaining members.
- **Chair:** The CAT is chaired by the longest-serving IST member of the highest academic rank, excluding members of the supervisory team.
...
- development of models, methods, analyses, or empirical studies to support decision-making and public policy design
...
The thesis must present an original scientific contribution in the area of Engineering and Public Policy — typically in the design, analysis, and evaluation of public policies in domains where technology is a determining factor — and demonstrate the capacity for autonomous research, methodological mastery, and a critical framing of the problem studied.
